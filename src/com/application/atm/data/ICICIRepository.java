...
public class ICICIRepository extends BankRepository{
    ...
    private void fillMockData() {
        Account account1 = new Account(123456, 1223, new User("Ram Pa", 26, "Olapadi, Salem",6253675), 225000,"ICICI",null);
        Account account2 = new Account(123457, 5221, new User("Jashwin S", 27, "Hosur, Krishnagiri",6235645), 125000,"ICICI",null);
        Account account3 = new Account(123458, 4093, new User("kishore S", 24, "Urapakkam, Chennai",5413235), 11520,"ICICI",null);
